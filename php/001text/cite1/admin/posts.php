...
<body>
  ...
  <div class="main">
    ...
    <div class="container-fluid">
      ...
      <div class="page-action">
        ...
        <form class="form-inline" action="<?php echo $_SERVER['PHP_SELF']; ?>">
          <select name="category" class="form-control input-sm">
            ...
            <!-- 循环所有的分类，判断当前的分类是不是已有的分类，如果选中了就设置为选中状态 -->
          ...
          <select name="status" class="form-control input-sm">
            ...
            <option value="trashed"<?php echo isset($_GET['status']) && $_GET['status'] == 'trashed' ? ' selected' : '' ?>>回收站</option>
             <option value="trashed"<?php echo isset($_GET['status']) && $_GET['status'] == 'unpublished' ? ' selected' : '' ?>>未发布</option>
          </select>
      ...
      <ul class="pagination pagination-sm pull-right" >
          ...
          <li<?php echo $i === $page ? ' class="active"' : '' ?> id="zs"><a href="?page=<?php echo $i . $search; ?>"><?php echo $i; ?></a></li>
          <?php endfor ?>
          <li><a id="kd2">下一页</a></li>
        </ul> 
      </div>
      <table class="table table-striped table-bordered table-hover">
        ...
        <tbody id="tbod">
          ...
          <tr >
            ...
            <td id="sss"><?php echo $item['title']; ?></td>
  ...
  <script>
      var sy = document.getElementById('kd');
      sy.onclick = function () {
//          alert(11);
          <?php if ($page != 1 ): ?>
                sy.href = "?page=<?php echo $page-1 . $search; ?>";
          <?php endif  ?>
      };
      var sy2 = document.getElementById('kd2');
      sy2.onclick = function () {
//         alert(1111);
          <?php if ($page != 51 ): ?>
            sy2.href = "?page=<?php echo $page+1 . $search; ?>";
          <?php endif  ?>
      };
      var sy3 = document.getElementById('tbod').children;
          for(var i = 0 ; i < sy3.length ; i++){
                sy3[i].onclick=function () {
//                    console.log(this.childNodes[3].innerText);
                    var title = this.childNodes[3].innerText;
                    var link ="./text11.html" + '?title='+encodeURI(title) ;
